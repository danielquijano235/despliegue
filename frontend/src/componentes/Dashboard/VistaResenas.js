...
const resenasEjemplo = [
  {
    ...
    calificacion: 5,
    comentario:
      "Excelente atención y comida espectacular. El sistema de reservas fue muy fácil de usar, llegamos y nuestra mesa estaba lista. Volveremos sin duda.",
    fecha: "2026-02-08",
  },
  {
    id: 2,
    ...
    calificacion: 4,
    comentario:
      "Muy buena experiencia en general. La comida deliciosa y el ambiente agradable. Solo tardaron un poco en traer los platos.",
    fecha: "2026-02-07",
  },
  {
    id: 3,
    ...
    calificacion: 5,
    comentario:
      "Celebramos un cumpleaños y todo salió perfecto. El personal fue muy amable y la decoración de la mesa fue un detalle hermoso.",
    fecha: "2026-02-06",
  },
  {
    id: 4,
    ...
    calificacion: 3,
    comentario:
      "La comida estaba bien pero esperábamos más variedad en el menú. El servicio fue correcto aunque un poco lento en hora punta.",
    fecha: "2026-02-05",
  },
  {
    id: 5,
    ...
    calificacion: 5,
    comentario:
      "Increíble experiencia. Pedimos el menú degustación y cada plato fue una sorpresa. El sommelier nos recomendó un vino perfecto.",
    fecha: "2026-02-04",
  },
  {
    id: 6,
    ...
    calificacion: 4,
    comentario:
      "Buena relación calidad-precio. El postre de la casa es imperdible. Reservamos por la app y fue muy cómodo.",
    fecha: "2026-02-03",
  },
  {
    id: 7,
    ...
    calificacion: 5,
    comentario:
      "Como cliente VIP, siempre recibo un trato excepcional. La mesa privada es perfecta para reuniones de negocios.",
    fecha: "2026-02-02",
  },
  {
    id: 8,
    ...
    calificacion: 4,
    comentario:
      "La terraza tiene una vista espectacular. La comida sin gluten que pedí estaba muy bien preparada y sabrosa.",
    fecha: "2026-02-01",
  },
];

const VistaResenas = ({ limit = null, compact = false }) => {
  // Leer reseñas demo desde localStorage y combinarlas con las de ejemplo
  const [resenas, setResenas] = useState(() => {
    const demo = JSON.parse(localStorage.getItem("resenasDemo") || "[]");
    return [...demo, ...resenasEjemplo];
  });
  ...
  const resenasMostradas = limit
    ? resenasFiltradas.slice(0, limit)
    : resenasFiltradas;
    ...
    <div className="vista-modulo">
        ...
        <div className="modulo-header">
          <div>
            ...
            <p className="modulo-subtitulo">
              {resenas.length} reseñas en total
            </p>
          </div>
        </div>
      )}
      ...
      <div className="resenas-resumen">
        <div className="resena-resumen-principal">
          ...
          <div className="resena-promedio-estrellas">
            {renderEstrellas(Math.round(promedio))}
          </div>
          <span className="resena-promedio-texto">
        ...
        <div className="resena-resumen-barras">
          <div className="resena-barra-fila">
            <span>5 ★</span>
            <div className="resena-barra-fondo">
              <div
                className="resena-barra-llena"
                style={{
                  width: `${(total5 / resenas.length) * 100}%`,
          ...
          <div className="resena-barra-fila">
            ...
            <div className="resena-barra-fondo">
              <div
                className="resena-barra-llena"
                style={{
                  width: `${(total4 / resenas.length) * 100}%`,
          ...
          <div className="resena-barra-fila">
            ...
            <div className="resena-barra-fondo">
              <div
                className="resena-barra-llena"
                style={{
                  width: `${(total3 / resenas.length) * 100}%`,
